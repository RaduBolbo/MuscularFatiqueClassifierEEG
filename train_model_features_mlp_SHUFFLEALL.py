...
data_directory = r'.\dataset\NON_OVERLAPING_DATASET\dataset_labeled_divided_nonoverlaped_features'
...
# 1. INSTANTIATE
mlp_model = MLPClassifier(hidden_layer_sizes=(256, 128, 64, 32, 16), activation='relu', 
